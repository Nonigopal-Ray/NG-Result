...
class ColorPDF(FPDF):
    ...
    def footer(self):
        ...
        # Clickable Facebook Link in Developer Name
        fb_url = "https://www.facebook.com/nonigopalrays"
        self.cell(140, 5, f"App Developed by: Nonigopal Ray | Dinajpur Board SSC {self.year} Result System", align="L", link=fb_url)
        
        self.set_text_color(100, 100, 100)
        self.cell(0, 5, f"Page {self.page_no()}/{{nb}}", align="R")

    def format_subject_lines(self, text, max_width):
        """Splits subject grade text into multiple lines with smaller font size (5pt)."""
        self.set_font("Helvetica", "", 5)  # Reduced font size to 5pt
    ...
    def draw_colored_grades(self, x, y, line_lines):
        """Draws subject grades neatly with small font size (5pt)."""
        self.set_font("Helvetica", "", 5)  # Reduced font size to 5pt
        curr_y = y + 1.8
...
def generate_pdf(dataframe, institute_info, year):
    ...
    for _, row in dataframe.iterrows():
        ...
        # Calculate dynamic row height based on 5pt subject grade lines
