...
st.markdown('<div class="developer-badge">✨ App Developed by: <a style="color: white" href="https://www.facebook.com/nonigopalrays" target="_blank">Nonigopal Ray</a> ✨</div>', unsafe_allow_html=True)
st.write("---")
...
class ColorPDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(140, 5, f"App Developed by: Nonigopal Ray | Dinajpur Board SSC {self.year} Result System", align="L")
        self.cell(0, 5, f"Page {self.page_no()}/{{nb}}", align="R")

    def format_subject_lines(self, text, max_width):
        """Splits subject grade text into multiple lines ensuring no subject is cut off."""
    ...
    def draw_colored_grades(self, x, y, width, line_lines):
        """Draws structured subject grades with color highlight for fail grades."""
        self.set_font("Helvetica", "", 7)
        curr_y = y + 2.5
...
def generate_pdf(dataframe, institute_info, year):
    ...
    for _, row in dataframe.iterrows():
        ...
        pdf.draw_colored_grades(x + sum(widths[:5]), y, widths[5], grade_lines)
...
# Developer Photo Section (Iframe Embed)
st.write("---")
st.subheader("👨‍💻 Developer Profile")
developer_iframe_html = """
<iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fweb.facebook.com%2Fnonigopalrays%2Fposts%2F122124760767127318%3A2714507345572582&show_text=true&width=500" 
        width="500" height="586" style="border:none;overflow:hidden; display:block; margin:auto;" 
        scrolling="no" frameborder="0" allowfullscreen="true" 
        allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share">
</iframe>
"""
components.html(developer_iframe_html, height=600)
